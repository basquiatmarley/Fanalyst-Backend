...
<div class="row mb-6">
            ...
            <label class="col-lg-4 col-form-label fw-semibold fs-6">
              ...
              <i
                ...
                title="Can edit events group title"
              ></i>
            </label>
            <!--end::Label-->
...
const getData = async (id) => {
  try {
    ...
    const response = await ApiService.query(`events/${id}`,{params : {filter : {include: [
          {
...
const postEditHandle = async (id,params) => {
  try {
    ApiService.setHeader();
    const response = await ApiService.put(`events/${id}`,params);
